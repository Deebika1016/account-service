...
public class AccountController {
    ...
    public ResponseEntity<List<AccountDto>> getAccountByCustomerId(@PathVariable String customerId,@RequestParam(defaultValue = "0") Integer page,
        ...
        UserDto userDto = Optional.ofNullable(responseEntityUserDto.getBody()).filter(Objects::nonNull)
                .orElseThrow(()->new CustomerNotFoundException("Account details not available because Customer Id-" + customerId + " not found."));
